create or replace package body ZJJK_DATAEX_VALIDATE is
 ...
 --------part1
  ...
  --update zjjk.zjjk_xnxg_bgk_ex ex set ex.validate_detail = ex.validate_detail || '时间间隔为空;'
  --where ex.vc_cgzsjjg is null;
  update zjjk.zjjk_xnxg_bgk_ex ex set ex.validate_detail = ex.validate_detail || '时间间隔错误;'
...
--VC_SHWBYY  伤害外部原因编码    选填    VARCHAR2(10)
  ...
  -- vc_txyshs, vc_shbz, dt_shsj,  vc_sfjdc（新表核实是什么）   vc_qsx, vc_tb, vc_xz, vc_rzzs, vc_ggj, vc_sz, vc_qg, vc_hxd, vc_xhd, vc_sjxt,
   ...
   insert into zjjk_shjc_bgk_ex_bak
     (vc_yyrid, dt_yytjrq, vc_jkdw, vc_xm, vc_xb, vc_nl, vc_dh, dt_shrq, dt_jzrq, vc_zz, vc_hj, vc_zy, vc_zyqt, vc_fsdd, vc_fsddqt, vc_shyy, vc_shyyqt, vc_shszsm, vc_shszsmqt, vc_yzcd, vc_fsqsfyj, vc_brddqk, vc_brddqkqt, vc_sfgy, vc_jj, vc_sfjdc, vc_sszjtgj, vc_sszjtgjqt, vc_sszqk, vc_sszqkqt, vc_sszhsmfspz, vc_sszhsmfspzqt, vc_czjdcsszdwz, vc_zwywanqd, vc_anqdsy, vc_ywbhzz, vc_bhzzsy, vc_zyxgys, vc_zyxgysqt, vc_yqzsfsdcs, vc_shqy, vc_shqyqt, vc_sszysrg, vc_sszysrgxqt, vc_sygj, vc_sygjqt, vc_shxz1, vc_shxz2, vc_shxz3, vc_ssbw1, vc_ssbw2, vc_ssbw3, vc_sjzy, vc_shwbyy, vc_hzjzkb, vc_hzjzkbqt, vc_txyshs, vc_shbz, is_pass, validate_detail, validate_date)
   select vc_yyrid, dt_yytjrq, vc_jkdw, vc_xm, vc_xb, vc_nl, vc_dh, dt_shrq, dt_jzrq, vc_zz, vc_hj, vc_zy, vc_zyqt, vc_fsdd, vc_fsddqt, vc_shyy, vc_shyyqt, vc_shszsm, vc_shszsmqt, vc_yzcd, vc_fsqsfyj, vc_brddqk, vc_brddqkqt, vc_sfgy, vc_jj, vc_sfjdc, vc_sszjtgj, vc_sszjtgjqt, vc_sszqk, vc_sszqkqt, vc_sszhsmfspz, vc_sszhsmfspzqt, vc_czjdcsszdwz, vc_zwywanqd, vc_anqdsy, vc_ywbhzz, vc_bhzzsy, vc_zyxgys, vc_zyxgysqt, vc_yqzsfsdcs, vc_shqy, vc_shqyqt, vc_sszysrg, vc_sszysrgxqt, vc_sygj, vc_sygjqt, vc_shxz1, vc_shxz2, vc_shxz3, vc_ssbw1, vc_ssbw2, vc_ssbw3, vc_sjzy, vc_shwbyy, vc_hzjzkb, vc_hzjzkbqt, vc_txyshs, vc_shbz, is_pass, validate_detail, validate_date from zjjk_shjc_bgk_ex;
...
--死亡（死因）========================================================================
 ...
 --------part1
   ...
   */
   ...
   where checkdic('C_COMM_SHEDM',ex.VC_HKSHEDMWS)=0 and ex.VC_HKSHEDMWS is not null;
   ...
   where (checkdic('C_COMM_SJDM',ex.vc_hksdmzjs)=0 and ex.vc_hksdmzjs is not null) or
         (checkdic('C_COMM_SJDM',ex.vc_hkshidmws)=0 and ex.vc_hkshidmws is not null)
   ;
   ...
   where (checkdic('C_COMM_QXDM',ex.VC_HKQXDMZJS)=0 and ex.VC_HKQXDMZJS is not null) or
         (checkdic('C_COMM_QXDM',ex.vc_hkqxdmws)=0 and ex.vc_hkqxdmws is not null);
  ...
  -- where ex.vc_hkjddm is null;
   ...
   where (checkdic('C_COMM_JDDM',ex.VC_HKJDDMZJS)=0 and ex.VC_HKJDDMZJS is not null) or
         (checkdic('C_COMM_JDDM',ex.VC_HKJDDMWS)=0 and ex.VC_HKJDDMWS is not null);
   ...
   update zjjk.zjjk_sw_bgk_ex ex set ex.validate_detail = ex.validate_detail || '居住省错误;'
   where checkdic('C_COMM_SHEDM',ex.VC_JZSHEDMWS)=0 and ex.VC_JZSHEDMWS is not null;
   ...
   where (checkdic('C_COMM_SJDM',ex.VC_JZSDMZJS)=0 and ex.VC_JZSDMZJS is not null) or
         (checkdic('C_COMM_SJDM',ex.VC_JZSHIDMWS)=0 and ex.VC_JZSHIDMWS is not null);
   ...
   where (checkdic('C_COMM_QXDM',ex.VC_JZQXDMZJS)=0 and ex.VC_JZQXDMZJS is not null) or
         (checkdic('C_COMM_QXDM',ex.VC_JZQXDMWS)=0 and ex.VC_JZQXDMWS is not null);

   --目前居住地址街道
   update zjjk.zjjk_sw_bgk_ex ex set ex.validate_detail = ex.validate_detail || '居住街道错误;'
   where (checkdic('C_COMM_JDDM',ex.VC_JZJDDMZJS)=0  and ex.VC_JZJDDMZJS is not null) or
         (checkdic('C_COMM_JDDM',ex.VC_JZJDDMWS)=0  and ex.VC_JZJDDMWS is not null);
  ...
  where ex.DT_BKRQ is null;
  update zjjk.zjjk_sw_bgk_ex ex set ex.validate_detail = ex.validate_detail || '报卡日期小于平台创建日期;'
...
VC_JKYS,
VC_AZJSWJB,NB_AZJSWJBICD,VC_AFBDSWSJJG,VC_BZJSWJB,NB_BZJSWJBIDC,VC_BFBDSWSJJG,VC_CZJSWJB,NB_CZJSWJBICD,VC_CFBDSWSJJG,VC_DZJSWJB,NB_DAJSWJBICD,VC_DFBDSWSJJG,VC_EZJSWJB,NB_EAJSWJBICD,VC_EFBDSWSJJG,VC_FZJSWJB,NB_FAJSWJBICD,VC_FFBDSWSJJG,VC_GZJSWJB,NB_GAJSWJBICD,VC_GFBDSWSJJG,
VC_RSQK,
...
Procedure Proc_Zjjk_Exe_Validate is
  ...
  begin
      zjjk.zjjk_dataex_validate.Proc_Zjjk_Xnxg_Validate;
      zjjk.zjjk_dataex_validate.Proc_Zjjk_Shjc_Validate;
      zjjk.zjjk_dataex_validate.Proc_Zjjk_Sw_Validate;
  end;
