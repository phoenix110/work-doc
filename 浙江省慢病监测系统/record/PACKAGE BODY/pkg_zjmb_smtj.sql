    ...
    if v_vc_bgkid is null then
      ...
      values
        (v_vc_bgkid,
         ...
         '0',
         v_nb_gbsybm);
      --死亡报告卡新增时，同步写入 zjmb_sw_wjw_bgk
      insert into zjmb_sw_wjw_bgk
        (vc_bgkid,
         vc_wshkqxdm,
         vc_wshkjddm,
         vc_wshkjw,
      ...
      update zjmb_sw_bgk
         set vc_wshkqxdm    = v_vc_wshkqxdm,
             ...
             dt_sfsj = case when v_vc_hkhs is not null and v_vc_shbz <> '1' and v_vc_shbz <> '3' and dt_sfsj is null then
               v_sysdate
               when (v_vc_hkhs is not null and v_vc_shbz <> '1' and dt_sfsj is not null) or v_vc_shbz = '3' then
                 dt_sfsj
             else
               null
             end,
