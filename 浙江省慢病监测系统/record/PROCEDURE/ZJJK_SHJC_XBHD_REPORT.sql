create or replace procedure      zjjk_shjc_xbhd_report
(
...
is
  begin
       ...
       where ty.vc_shszsm is not null
             and ty.vc_bgkzt='0'
       ...
       group by ty.vc_shszsm order by ty.vc_shszsm;
       ...
       where ty.code_info_id='21'
       order by ty.code;

  end zjjk_shjc_xbhd_report;
