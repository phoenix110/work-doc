create or replace procedure      updateGJSJDR2
is
 ...
 where to_date(t.vc_swsj,'yyyy-MM-dd') = t1.dt_swrq
 and t.vc_bgkid in (
  select t.vc_bgkid
 ...
 and  not exists ( select t3.vc_bgkid
    ...
    if (length(trim(a2)) = 2) then
      ...
      ,t.dt_lrsj=a4,t.dt_shsj=a6
             where t.vc_bgkid=a3 ;
       insert into zjjk_swbgk_temp4 (select * from zjjk_swbgk_temp1 where vc_bgkid=a5);
        commit;
      end loop;
      close p_cur1;
end updateGJSJDR2;
