create or replace procedure      zjjk_shjc_xbfsdd_report
(
...
is
  begin
       ...
       group by ty.vc_fsdd order by ty.vc_fsdd;
       ...
       where ty.code_info_id='20'
       order by ty.code;

  end zjjk_shjc_xbfsdd_report;
