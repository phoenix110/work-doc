create or replace procedure      updateGJSJDR1
is
 ...
 where to_date(t.vc_csrq,'yyyy-MM-dd') = t1.dt_csrq
 ...
 where to_date(t.vc_csrq,'yyyy-mm-dd') = t1.dt_csrq group by t.vc_bgkid having count(t.vc_bgkid)=1);
    ...
    if (length(trim(a2)) = 2) then
      ...
      ,t.dt_lrsj=a4,t.dt_shsj=a6
             where t.vc_bgkid=a3 ;
       insert into zjjk_swbgk_temp3 (select * from zjjk_swbgk_temp1 where vc_bgkid=a5);
        commit;
      end loop;
      close p_cur1;
end updateGJSJDR1;
