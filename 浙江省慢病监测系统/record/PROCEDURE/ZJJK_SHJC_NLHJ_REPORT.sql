create or replace procedure      zjjk_shjc_nlhj_report
(
...
is
  begin
       open p_cur for
       select ty.vc_hj,
              decode(ty.vc_hj,1,'insideArea',2,'insideProvince',3,'outProvince',4,'foreign') vc_hjname,
       ...
       group by ty.vc_hj order by ty.vc_hj;
