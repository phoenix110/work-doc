create or replace procedure      zjjk_shjc_xbyffssj_report
(
 beginDate in varchar2,--伤害发生时间年份
...
is
  begin
       open p_cur for
       select to_number(to_char(ty.dt_shrq,'MM')) dt_shrq,
