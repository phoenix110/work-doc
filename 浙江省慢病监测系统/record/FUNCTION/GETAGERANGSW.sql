create or replace function      GetAgeRangSw(dtCsrq Date,dtSwrq Date) return varchar2 is
  Result varchar2(30);
  tempcount integer;
  tempcount2 integer;
begin
    If dtCsrq Is Not Null Then
       Select dtSwrq-dtCsrq Into tempcount From dual;
       Select (dtSwrq-dtCsrq)/365.25 Into tempcount2 From dual;
       if (tempcount>365) then
