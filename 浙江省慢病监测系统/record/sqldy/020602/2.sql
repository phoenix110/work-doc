SELECT decode(vc_bgklb,
       ...
       pkg_zjmb_tnb.fun_getxzqhmc(vc_hksdm) hkdzsi,
       pkg_zjmb_tnb.fun_getxzqhmc(vc_hkqxdm) hkdzqx,
       pkg_zjmb_tnb.fun_getxzqhmc(vc_hkjddm) hkdzjd,
       vc_hkjw hkxxdz,
       vc_hkxxdz mqjzdz,
       vc_hyzk || '  ' ||
       (SELECT t.name
       ...
       vc_jzsdm || '  ' ||
       pkg_zjmb_tnb.fun_getxzqhmc(vc_jzsdm) jzsidm,
       vc_jzqxdm || '  ' ||
       pkg_zjmb_tnb.fun_getxzqhmc(vc_jzqxdm) jzqdm,
       vc_jzjddm || '  ' ||
       pkg_zjmb_tnb.fun_getxzqhmc(vc_jzjddm) jzjddm,
       vc_jzjw jzxxdz,
       vc_wsjzshendm || '  ' ||
          ...
          FROM (SELECT
           ...
           where 1=1
             <if if(StringUtils.isNotBlank(#{xzqh_organ}))>
                and exists (select 1 from TABLE(split(#{xzqh_organ}, ',')) xt where bgk.vc_hkjddm like xt.column_value || '%')
             </if>
             ...
             <if if(StringUtils.isNotBlank(#{dt_sczdrq_ks}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
               and bgk.dt_sczdrq >= to_date(#{dt_sczdrq_ks},'yyyy-MM-dd HH24:mi:ss')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_sczdrq_js}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
               and bgk.dt_sczdrq <= to_date(#{dt_sczdrq_js},'yyyy-MM-dd HH24:mi:ss')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             ...
             <if if(StringUtils.isNotBlank(#{dt_bgrq_ks}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
               and bgk.dt_tbrq >= to_date(#{dt_bgrq_ks},'yyyy-MM-dd HH24:mi:ss')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_bgrq_js}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
               and bgk.dt_tbrq <= to_date(#{dt_bgrq_js},'yyyy-MM-dd HH24:mi:ss')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_swrq_ks}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
               and bgk.dt_swrq >= to_date(#{dt_swrq_ks},'yyyy-MM-dd HH24:mi:ss')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_swrq_js}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
               and bgk.dt_swrq <= to_date(#{dt_swrq_js},'yyyy-MM-dd HH24:mi:ss')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_cjsj_ks}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
               and bgk.dt_cjsj >= #{dt_cjsj_ks}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_cjsj_js}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
               and bgk.dt_cjsj <= #{dt_cjsj_js}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_qxshsj_ks}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
               and bgk.dt_qxshsj >= #{dt_qxshsj_ks}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
             <if if(StringUtils.isNotBlank(#{dt_qxshsj_js}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
               and bgk.dt_qxshsj <= #{dt_qxshsj_js}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
             <if if(StringUtils.isNotBlank(#{vc_hkqcs}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
               and bgk.vc_hkqcs = #{vc_hkqcs}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
              <if if(StringUtils.isNotBlank(#{vc_hksdm}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
               and bgk.vc_hksdm = #{vc_hksdm}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
              <if if(StringUtils.isNotBlank(#{vc_hkqxdm}))>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
               and bgk.vc_hkqxdm = #{vc_hkqxdm}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
             </if>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
