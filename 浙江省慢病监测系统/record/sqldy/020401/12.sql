select vc_bgkbh as vc_bgkbh,
       ...
       vc_czhkqx || '  ' ||
       pkg_zjmb_tnb.fun_getcommdic('C_COMM_QXDM', vc_czhkqx) as vc_czhkqx,
       vc_czhkjd || '  ' ||
       pkg_zjmb_tnb.fun_getcommdic('C_COMM_JDDM', vc_czhkjd) as vc_czhkjd,
       vc_czhkjw,
       vc_czhkxxdz,
       ...
       vc_mqjzqx || '  ' ||
       pkg_zjmb_tnb.fun_getcommdic('C_COMM_QXDM', vc_mqjzqx) as vc_mqjzqx,
       vc_mqjzjd || '  ' ||
       pkg_zjmb_tnb.fun_getcommdic('C_COMM_JDDM', vc_mqjzjd) as vc_mqjzjd,
       vc_mqjzjw,
       vc_mqxxdz,
       vc_gzdw,
       ...
       vc_bs,
       vc_bkdwyy || '  ' ||
       pkg_zjmb_tnb.fun_getcommdic('C_COMM_YYDM', vc_bkdwyy) as vc_bkdwyy,
       vc_bkys,
