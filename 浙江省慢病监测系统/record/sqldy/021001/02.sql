                 ...
                 where bgk.vc_scbz = '2'
                   ...
                   AND EXISTS (SELECT 1
                                ...
                                WHERE trunc(bgk.dt_cjsj) > trunc(sj.dt_ksrq)
                                  ...
                                  AND sj.ccbz LIKE '%2%'
                                  AND (sj.gxbicd10 IS NULL OR sj.gxbicd10||',' LIKE '%'||SUBSTR(bgk.vc_hzicd,0,3)||',%')
                                  AND (sj.bgkzt is null or bgk.vc_kzt in (select column_value from TABLE(split(sj.bgkzt, ','))))
                                  AND sj.zt='1')
