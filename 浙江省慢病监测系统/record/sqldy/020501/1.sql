  ...
  from (select vc_bgkid,
        ...
        from (select  /*+INDEX(a INDEX_CS_GLDW)*/   a.vc_bgkid,
                   ...
                   <if if("A1".equals(#{jglx}))>
                       and a.vc_jsdw like #{vc_gldw} || '%'
                   </if>
                   <if if("B1".equals(#{jglx}))>
                       and ((a.vc_shbz = '1' and a.vc_jsdw like #{vc_gldw} || '%') or 
                       (a.vc_shbz != '1' and (a.vc_gldwdm like #{vc_gldw}||'%' or a.vc_czdwdm like #{vc_gldw}||'%' or a.vc_jkdw like #{vc_gldw}||'%' or a.vc_jddm like #{jgszqh} || '%')))
                   </if>
                     <if if(!"A1".equals(#{jglx}) && !"B1".equals(#{jglx}) && StringUtils.isNotBlank(#{jgszqh}))>
                         and (a.vc_gldwdm like #{vc_gldw}||'%' or a.vc_czdwdm like #{vc_gldw}||'%' or a.vc_jkdw like #{vc_gldw}||'%' or a.vc_jddm like #{jgszqh} || '%')
                     </if>
                     <if if(!"A1".equals(#{jglx}) && !"B1".equals(#{jglx}) && StringUtils.isBlank(#{jgszqh}))>
                         and (a.vc_gldwdm like #{vc_gldw}||'%' or a.vc_czdwdm like #{vc_gldw}||'%' or a.vc_jkdw like #{vc_gldw}||'%')
                     </if>
                     and a.vc_scbz = '2'
