select vc_bgkid,
  ...
  from (select vc_bgkid,
          ...
          from (select bgk.vc_bgkid,
                  ...
                  from ZJJK_ZL_BGK bgk, ZJJK_ZL_HZXX hzxx,(select distinct column_value column_value from table(split(#{table}, ','))) c
                 where BGK.VC_HZID = HZXX.VC_PERSONID
                     and BGK.vc_bgkzt in ('0','2','3','6','7')
                     and BGK.vc_scbz = '0'
                     and HZXX.vc_hzxm = arr(c.column_value, 1, '||')
                     and HZXX.vc_hzxb = arr(c.column_value,2, '||')
                     and hzxx.vc_sfzh = arr(c.column_value,3, '||')
