with tab as
 (select dm, mc qymc, bks, bgjss, shjss, zzqss, cks
    from (select dm, mc from p_yljg where dm like substr(#{vc_hkqx}, 1, 6)||'%' and lb <> 'J1') a,
         (select vc_cjdwdm qydm,
           ...
           where t.vc_scbz = '0'
             ...
             and t.vc_bgkzt = '0'
             and t.vc_cjdwdm like substr(#{vc_hkqx}, 1, 6)||'%'
         ...
         (select count(distinct t1.vc_bgkid) cks,
           ...
           where t1.vc_bgkid <> t2.vc_bgkid
             ...
             and t1.vc_cjdwdm like substr(#{vc_hkqx}, 1, 6) || '%'
             and t2.vc_cjdwdm like substr(#{vc_hkqx}, 1, 6) || '%'
             </if>
             <if if(StringUtils.isNotBlank(#{dt_jzsj_ks}))>
