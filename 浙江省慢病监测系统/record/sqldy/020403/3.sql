select vc_bgkid,
  ...
  from (select vc_bgkid,
          ...
          from (select bgk.vc_bgkid,
                   ...
                   from zjjk_xnxg_bgk bgk, (select distinct column_value column_value from table(split(#{table}, ','))) c
                 where 1=1
                     and bgk.vc_kzt in ('0','2','3','6','7')
                     and bgk.vc_scbz = '2'
                     and bgk.vc_hzxm = arr(c.column_value, 1, '||')
                     and bgk.vc_hzxb = arr(c.column_value,2, '||')
                     and bgk.vc_hzsfzh = arr(c.column_value,3, '||')
