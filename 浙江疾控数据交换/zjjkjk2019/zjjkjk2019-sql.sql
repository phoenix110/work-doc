...
-- 旧：每天凌晨3点会定时回传（传7天前的00:00:00到昨天23:59:59之间的数据)
-- 新：每10分钟（传7天前的00:00:00到10分钟前的数据)
...
-- 要回推的地区配置表，回传数据的时候，不同地市是按照integration来区分的，发送的xml报文中integration字段对应的是DispatchCode
